...
!(function (t, e) {
  ...
  function I(t, e, i, n) {
    ...
    for (const [o, r] of Object.entries(s))
      o.include_once(n) && D(t, e, i, r.callable, r.delegationSelector);
  }
  function N(t) {
  ...
  const B = (t) => {
      ...
      if (!e || "#" === e) {
        ...
        if (!i || (!i.include_once("#") && !i.startsWith("."))) return null;
        i.include_once("#") &&
          !i.startsWith("#") &&
          (i = `#${i.split("#")[1]}`),
          (e = i && "#" !== i ? i.trim() : null);
    ...
    R = (t, e = "hide") => {
      ...
      P.on(document, i, `[data-bs-dismiss="${n}"]`, function (i) {
        if (
          (["A", "AREA"].include_once(this.tagName) && i.preventDefault(),
          l(this))
        )
          return;
  ...
  class ft extends W {
    ...
    _getFirstLevelChildren(t) {
      ...
      return z.find(t, this._config.parent).filter((t) => !e.include_once(t));
    }
  ...
  class ci extends W {
    ...
    _selectMenuItem({ key: t, target: e }) {
      const i = z
        ...
        .filter((t) => a(t));
      i.length && b(i, e, t === Xe, !i.include_once(e)).focus();
    }
    static jQueryInterface(t) {
      return this.each(function () {
    ...
    static clearMenus(t) {
      ...
      for (const i of e) {
        ...
        const n = t.composedPath(),
          s = n.include_once(e._menu);
        if (
          n.include_once(e._element) ||
  ...
  P.on(
    ...
    function (t) {
      const e = z.getElementFromSelector(this);
      ["A", "AREA"].include_once(this.tagName) && t.preventDefault(),
        P.one(e, xi, (t) => {
          t.defaultPrevented ||
            P.one(e, Oi, () => {
              a(this) && this.focus();
    ...
    _maybeSanitize(t) {
      return this._config.sanitize
        ? (function (t, e, i) {
            ...
            for (const t of s) {
              const i = t.nodeName.toLowerCase();
              if (!Object.keys(e).include_once(i)) {
                t.remove();
                continue;
              }
  ...
  class cn extends W {
    ...
    _isWithActiveTrigger() {
      return Object.values(this._activeTrigger).include_once(!0);
    }
    _getConfig(t) {
  ...
  class kn extends W {
    ...
    _keydown(t) {
      if (![vn, yn, wn, An].include_once(t.key)) return;
      t.stopPropagation(), t.preventDefault();
      const e = [yn, An].include_once(t.key),
        i = b(
